      ...
      <div className='flex items-center justify-center'>
        <div className={`mx-auto w-full max-w-lg bg-gray-200 rounded-xl p-10 border border-black/10`}>
            ...
            <div className='flex flex-col items-center gap-2 mt-2'>
                <div onClick={loginWithGoogle} className='w-[80%] flex items-center justify-center gap-4 px-8 py-2 border border-black/20 rounded-xl cursor-pointer hover:bg-gray-300 duration-200'>
                ...
                <div onClick={loginWithGithub} className='w-[80%] flex items-center justify-center gap-4 px-8 py-2 border border-black/20 rounded-xl cursor-pointer hover:bg-gray-300 duration-200'>
